    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = ScalableBitmap(this, Slic3r::var("Snapmaker_Orca_192px.png"), wxBITMAP_TYPE_PNG);
...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("EdgeSlicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("EdgeSlicer is Based on Orca Slicer"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, "Snapmaker_Orca_about", 250);
    ...
    // version
    {
        ...
        auto version_string = _L("EdgeSlicer ") + " " + std::string(Snapmaker_VERSION);
...
// #endif
    ...
    /*text_list.push_back(_L("EdgeSlicer is based on BambuStudio, PrusaSlicer, and SuperSlicer."));
    ...
    text_list.push_back(_L("EdgeSlicer is forked from Orca Slicer by SoftFever."));
    ...
    text_list.push_back(_L("EdgeSlicer integrates some features from the 3D printing open-source community, with specific attributions provided in the code comments."));
    text_list.push_back(_L(""));
    text_list.push_back(_L("EdgeSlicer is licensed under the GNU Affero General Public License, version 3."));
