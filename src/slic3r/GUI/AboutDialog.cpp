...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("UltraOne is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("UltraOne is Based on Orca Slicer"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // version
    {
        ...
        auto version_string = _L("UltraOne ") + " " + std::string(Snapmaker_VERSION);
...
// #endif
    ...
    /*text_list.push_back(_L("UltraOne is based on BambuStudio, PrusaSlicer, and SuperSlicer."));
    ...
    text_list.push_back(_L("UltraOne is forked from Orca Slicer by SoftFever."));
    ...
    text_list.push_back(_L("UltraOne integrates some features from the 3D printing open-source community, with specific attributions provided in the code comments."));
    text_list.push_back(_L(""));
    text_list.push_back(_L("UltraOne is licensed under the GNU Affero General Public License, version 3."));
