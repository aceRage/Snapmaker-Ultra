...
namespace instance_check_internal
{
	...
	static bool  send_message(const std::string &message_text, const std::string &version)
	{
		...
		if ( !checker->IsAnotherRunning() ) */
		{
			...
			std::string		interface_name = "io.github.acerage.UltraOne.InstanceCheck.Object" + version;
			std::string   	method_name = "AnotherInstance";
			//std::string		object_name = "/com/prusa3d/prusaslicer/InstanceCheck";
			std::string		object_name = "/io/github/acerage/UltraOne/InstanceCheck/Object" + version;
...
void OtherInstanceMessageHandler::handle_message(const std::string& message) 
{
	...
	boost::regex re(R"(^(ultraone|snapmaker-orca|Snapmaker_Orca|prusaslicer|cura|bambustudio):\/\/open[\/]?\?file=)", boost::regbase::icase);
...
namespace MessageHandlerDBusInternal
{
	...
	static void respond_to_introspect(DBusConnection *connection, DBusMessage *request) 
	{
	    ...
	    const char  *introspection_data =
	        ...
	        "     </method>"
	        "   </interface>"
	        "   <interface name=\"io.github.acerage.UltraOne.InstanceCheck\">"
	...
	static DBusHandlerResult handle_dbus_object_message(DBusConnection *connection, DBusMessage *message, void *user_data)
	{
	    ...
	    std::string our_interface  = "io.github.acerage.UltraOne.InstanceCheck.Object" + wxGetApp().get_instance_hash_string();
...
void OtherInstanceMessageHandler::listen()
{
	...
	std::string			 interface_name = "io.github.acerage.UltraOne.InstanceCheck.Object" + instance_hash;
    std::string			 object_name 	= "/io/github/acerage/UltraOne/InstanceCheck/Object" + instance_hash;
