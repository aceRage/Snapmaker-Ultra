...
public:
    ...
    // ImageMap→Ultra PR1: manager lives on Print (same pattern as mixed_filament_manager).
    // load_entries from texture_mapping_definitions is wired in a later PR (Print::apply).
