...
void PerimeterGenerator::split_top_surfaces(const ExPolygons &orig_polygons, ExPolygons &top_fills,
    ...
    if (object_config->interface_shells || has_bounded_paint_depth) {
...
// A loop made of nothing but overhang paths lies entirely off the lower layer. (port of OrcaSlicer#15411)
