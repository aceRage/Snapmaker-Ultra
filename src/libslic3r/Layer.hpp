...
public:
    ...
    // ImageMap FULL PR2: side TM / PerimeterPathV2 scratch (empty when TM is off).
...
//    Polygons                    bridged;
    ...
    //BBS
    void    make_perimeters(const SurfaceCollection &slices, const LayerRegionPtrs &compatible_regions, SurfaceCollection* fill_surfaces, ExPolygons* fill_no_overlap, const ExPolygons *contoning_one_wall_shell_infill = nullptr);
